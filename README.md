...
- Custom data parsers designed to read live telemetry packets from racing simulators.
- Implementation of ESP32 firmware logic utilizing Hall effect sensors to map high-fidelity inputs for custom sim racing peripherals.
